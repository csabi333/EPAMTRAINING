var ProductService = (function(ProductItem){
    ...
    function searchProduct(searchParameters){
        //decide whether the user is searching using the form or searching by using a filter    
    ...
    function buildUriParams(searchParams) {
        ...
        //console.log("afterjson");     but here the tojson() i couldnt figure out why tojson ignores the category in the object
